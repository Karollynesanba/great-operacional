-- Emergency unlock for CRM operational clients.
-- Use this if the larger SQL scripts time out in the Supabase editor.
-- It only opens CRUD on operational_clients and defines the safe delete RPC.
