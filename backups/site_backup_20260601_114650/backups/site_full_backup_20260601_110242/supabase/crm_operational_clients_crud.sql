-- CRM Operational CRUD repair
-- Run this once in the Supabase SQL Editor.
-- Goal: allow any authenticated user to create, edit, and delete operational clients,
-- and keep deletes safe by removing related child records first.
