-- Finalizes the auth/profile schema so login and user data stay global across browsers and deploys.
-- Safe to re-run in environments where part of the schema already exists.
