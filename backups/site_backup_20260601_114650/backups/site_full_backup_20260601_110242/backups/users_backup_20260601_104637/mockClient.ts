...
function ensureOperationalProfiles() {
  mergeSeedRows('profiles', [
    ...
    { id: 'profile-carlos', full_name: 'Carlos André', email: 'ci.andrade99@gmail.com', is_active: true, operational_role: 'GESTOR', login_password: 'Great2026!', created_at: new Date().toISOString() },
