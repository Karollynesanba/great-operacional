...
function ensureOperationalProfiles() {
  mergeSeedRows('profiles', [
    ...
    { id: 'profile-augusto', full_name: 'Augusto David', email: 'augustodavid112@gmail.com', is_active: true, operational_role: 'ATENDENTE', login_password: 'Great2026!', created_at: new Date().toISOString() },
